...
onMounted(() => {
    ...
    product.pack_size_id = packSizes.value?.find(packSize => packSize.name === product.pack_size_id)?.id
})
</script>
<template>
    <main>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <ArgonButton class="mt-3" @click="update(route.params.id, selectedRetailers)"
